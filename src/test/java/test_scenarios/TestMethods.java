...
public class TestMethods {
	WebDriver driver;// Create global instance
	...
	public void beforetest() {
		...
		driver.get("https://www.saucedemo.com/");// Launching web site
	...
	public void VerifyLogin() {
		...
		LoginPage loginPage = new LoginPage(driver);// Created in method level not global level
		loginPage.login();
